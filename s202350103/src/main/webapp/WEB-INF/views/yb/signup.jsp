  ...
  <nav class="navbar navbar-light py-2">
    <div class="container justify-content-center justify-content-lg-between">
      ...
      <span class="navbar-text">
        이미 계정이 있으신가요? <a href="signin">회원가입</a>
      </span>
    </div>
  </nav>
</div>
       ...
       <!--  <div class="col-12 col-md-6 col-lg-4 order-lg-1 order-2">
        ...
        <div class="col-12 col-md-6 offset-lg-1 col-lg-4 order-lg-2 order-1">
          <div class="mb-lg-9 mb-5">
            <h1 class="mb-1 h2 fw-bold">도담도담 시작하기</h1>
            <p>환영합니다! <br>계정을 생성하시고 도담도담을 이용해보세요</p>
          </div>
          <!-- form -->
          <form>
            <div class="row g-3">
              <!-- col -->
              <div class="col">
                <!-- input --><input type="text" class="form-control" name="m_name" placeholder="이름을 입력해주세요" aria-label="First name"
                  required>
              </div>
             <!--  <div class="col">
