...
<c:if test="${totalOb2 eq 0 }">
	...
	<div class="alert alert-warning d-flex align-items-center" role="alert">
      ...
      <div>
			...
			<div class="center">
			<a href="innewbookList?nb_category1=1" ><img alt="책이미지" src="assets/images/png/hihibook.jpeg" class="mb-3 img-fluid" style="margin-left:100px; width: 700px;">
			<br>
			<button type="button" class="btn btn-success mb-2" style="margin-left: 100px;">새상품 보러가기</button>
			</a>
			</div>
