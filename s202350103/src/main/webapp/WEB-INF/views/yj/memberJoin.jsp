...
<div class="row my-10">
 ...
 <div class="offset-lg-1 col-lg-10 col-12">
    ...
    <form class="row" action="memberJoinForm">
          <!-- input -->
  ...
  * 수탁업체
    - 행정자치부
      ...
      · 개인정보 보유 및 이용 기간 : 행정자치부에서는 이미 보유하고 있는 개인정보이기 때문에 별도로 저장하지 않음
   		 ...
   		 <label class="form-label" for="comments"> 
          <strong >DADOK(다독) 서비스  이용약관</strong>
          </label><p>
...
(시행일) 본 약관은 2018년 8월 1일부터 시행됩니다. 개정된 약관의 적용일자 이전 이용자 또는 회원은 개정된 이용약관의 적용을 받습니다.      		
     		...
     		<label class="form-label" for="comments"> 
          <strong >판매자 이용약관 및 원칙</strong>
          </label><p>
			<input class="form-check-input"  type="checkbox" value="ck4" id="ck4" required="required">
			판매자 이용약관
          <textarea rows="3" id="comments" class="form-control">
1.이 약관 또는 개별약관에서 정하지 않은 사항은 전기통신사업법, 전자거래기본법, 정보통신망이용촉진및정보보호등에관한법률, 전자상거래등에서의소비자보호에관한법률 등 관련법령의 규정과 일반적인 상관례에 의합니다.
2.판매자는 회사가 제공하는 서비스를 이용함에 있어서 전자상거래등에서의소비자보호에관한법률(예시:공급서, 표시광고, 반품, 배송 등 통신판매에 관한 규정), 전자거래기본법(예시:소비자보호에 관한 규정), 소비자기본법(예시:사업자의 의무에 관한 규정), 표시광고의공정화에관한법률(예시:상품상세설명에 관련한 표시, 기재사항), 정보통신망이용촉진및정보보호등에관한법률(예시:개인정보보호에 관한 규정) 등 관련법령을 준수하여야 하며, 
이 약관의 규정을 들어 관련법령 위반에 대한 면책을 주장할 수 없습니다.
     		</textarea><p><p><p>
